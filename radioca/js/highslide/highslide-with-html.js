...
lang : {
	...
	loadingTitle : 'Quitter',
	focusTitle : 'Mettre au premier plan',
	fullExpandTitle : 'Taille réelle',
	creditsText : '',
	creditsTitle : '',
	...
	playText : 'jouer',
	playTitle : 'Diaporama (espace)',
	pauseText : 'Pause',
	pauseTitle : 'Pause diaporama (spacebar)',
	previousTitle : 'Précédent (<-)',
	nextTitle : 'Suivant (->)',
	moveTitle : 'Dépalcer',
	fullExpandText : 'plein écran',
	restoreTitle : ''
},
...
init : function () {
	if (!hs.container) {
		...
		hs.ie6SSL = (hs.ie && hs.ieVersion() <= 6 && location.protocol == 'index.html');
	}
},
domReady : function() {
	hs.isDomReady = true;
...
run : function () {
	...
	this.xmlHttp.open("GET.html", this.src, true);
...
if (document.readyState && hs.ie) {
	var src = (window.location.protocol == 'index.html') ? '://0' : 'javascript:void(0)';
	document.write(
